...
class OrderController{
	...
	public function show($hash, Response $response, Request $request, Twig $view, Order $order){
	...
	public function create(Request $request, Response $response, Customer $customer, Address $address, Order $order){
		$this->basket->refresh();
		...
		$result = Braintree_Transaction::sale([
			'amount' => $this->basket->subTotal() + 15,
